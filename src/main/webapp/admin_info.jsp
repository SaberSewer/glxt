...
<body>
            ...
            <div class="admin_modify_style" id="Personal">
                ...
                <div class="xinxi">
                    <div class="form-group"><label class="col-sm-3 control-label no-padding-right"
                        ...
                        <div class="col-sm-9"><input type="text" name="用户名" id="website-title" readonly="readonly"
                                value="<c:property value=" #session.user.username" />" class="col-xs-7 text_info"
                            disabled="disabled">
                    ...
                    <div class="form-group"><label class="col-sm-3 control-label no-padding-right"
                        ...
                        <div class="col-sm-9"><input type="text" name="年龄" id="website-title" value="24"
                                class="col-xs-7 text_info" disabled="disabled"></div>
                    </div>
                    <div class="form-group"><label class="col-sm-3 control-label no-padding-right"
                            for="form-field-1">手机号码： </label>
                        <div class="col-sm-9"><input type="text" name="手机号码" id="website-title"
                                value="<c:property value=" #session.user.phone" />" class="col-xs-7 text_info"
                            disabled="disabled"></div>
                    </div>
                    <div class="form-group"><label class="col-sm-3 control-label no-padding-right"
                            for="form-field-1">电子： </label>
                        <div class="col-sm-9"><input type="text" name="邮箱" id="website-title" value="<c:property value="
                                #session.user.email" />" class="col-xs-7 text_info" disabled="disabled"></div>
                    </div>
                    <div class="form-group"><label class="col-sm-3 control-label no-padding-right"
                            for="form-field-1">QQ： </label>
                        <div class="col-sm-9"><input type="text" name="QQ" id="website-title" value="<c:property value="
                                #session.user.qq" />" class="col-xs-7 text_info" disabled="disabled"> </div>
                    </div>
                    <div class="form-group"><label class="col-sm-3 control-label no-padding-right"
                    ...
                    <div class="form-group"><label class="col-sm-3 control-label no-padding-right"
                        ...
                        <div class="col-sm-9"> <span>
                                <c:property value="#session.user.registration" /></span></div>
                    </div>
    ...
    <div class="change_Pass_style" id="change_Pass">
        <ul class="xg_style">
            <li><label class="label_name">原&nbsp;&nbsp;密&nbsp;码</label><input xxx="原密码" name="" type="password" class=""
                    id="password"></li>
            <li><label class="label_name">新&nbsp;&nbsp;密&nbsp;码</label><input xxx="新密码" name="" type="password" class=""
                    id="Nes_pas"></li>
            <li><label class="label_name">确认密码</label><input xxx="再次确认密码" name="" type="password" class=""
                    id="c_mew_pas"></li>
